  ...
  return (
    <Layout>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
                  ...
                  {product.images.map((image, index) => (
                    <button
                      ...
                      className={`w-16 h-16 md:w-20 md:h-20 rounded-md overflow-hidden border-2 ${
                        selectedImage === image ? 'border-boutique-500' : 'border-transparent'
                      }`}
                    >
                      <img
                        src={image}
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="mt-4 flex items-center">
              {discountedPrice ? (
                <>
                  <span className="text-2xl font-bold text-boutique-700">${discountedPrice.toFixed(2)}</span>
            ...
            <div className="bg-gray-50 p-3 rounded-md flex items-start gap-3">
              <Truck className="h-5 w-5 text-boutique-600 mt-0.5" />
              <div>
              ...
              <div className="prose max-w-none">
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <tbody className="divide-y divide-gray-200">
                    <tr>
                      <td className="py-3 text-sm font-medium text-gray-900 whitespace-nowrap">Material</td>
                      <td className="py-3 text-sm text-gray-600">Premium quality</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm font-medium text-gray-900 whitespace-nowrap">Weight</td>
                      <td className="py-3 text-sm text-gray-600">0.5 kg</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm font-medium text-gray-900 whitespace-nowrap">Dimensions</td>
                      <td className="py-3 text-sm text-gray-600">25 x 10 x 5 cm</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm font-medium text-gray-900 whitespace-nowrap">Origin</td>
                      <td className="py-3 text-sm text-gray-600">Ethically made in Italy</td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm font-medium text-gray-900 whitespace-nowrap">Care</td>
                      <td className="py-3 text-sm text-gray-600">
                        Hand wash or gentle machine wash cold, line dry
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3 text-sm font-medium text-gray-900 whitespace-nowrap">SKU</td>
        ...
        {/* Related Products */}
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-boutique-700 mb-8">You May Also Like</h2>
